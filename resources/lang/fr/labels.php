...
return [
    'fields' => [
        ...
        'noted_at' => 'Noté le',
        'task' => 'Tâche',
        'when_does_it_start' => 'Quand commence-t-elle ?',
        ...
        'perf_notified_at' => 'Alerte de performance envoyée',
        'recovered_notified_at' => 'Alerte de rétablissement envoyée',
        'unit' => 'Unité',
    ...
    'sales' => [
        ...
        'alert_rate_limit_helper' => 'Les alertes de performance et de rétablissement sont en outre limitées par monitoring.perf_alert_rate_limit_minutes et monitoring.recovered_alert_rate_limit_minutes.',
    ...
    'money' => [
        ...
        'remaining' => 'restant',
        'remaining_on_order_line' => 'Il reste :quantity sur cette ligne de commande',
    ],
    ...
    'invitations' => [
        ...
        'revoke' => 'Révoquer',
        'revoke_confirm' => "Le lien d'invitation cesse de fonctionner immédiatement. Vous pourrez envoyer une nouvelle invitation ensuite.",
        'accept_title' => "Accepter l'invitation",
        'accept_heading' => 'Terminez la configuration de votre compte',
        'accept_subheading' => 'Choisissez un nom et un mot de passe pour accepter votre invitation.',
        'accept_action' => "Accepter l'invitation",
    ...
    'updates' => [
        ...
        'database_update_required_body' => 'La base de données est en retard sur le code installé. Exécutez php artisan laravelcrm:update pour la mettre à jour.',
        'how_to_update' => 'Comment mettre à jour',
        'how_to_update_intro' => 'Mettez à jour les deux paquets ensemble, puis exécutez la commande de mise à jour :',
        'upgrade_guide' => 'Guide de mise à niveau',
    ],

    // Paramètres → Modèles (sélecteur de modèles PDF)
    'templates' => [
        ...
        'doc_type_purchase_order' => 'Bons de commande',
        'doc_type_delivery' => 'Livraisons',
        'doc_type_quote' => 'Devis',
    ],
    ...
    'notifications' => [
        ...
        'user_invite_unavailable_body' => "Aucune route d'acceptation d'invitation n'est enregistrée, la personne invitée ne pourrait donc pas utiliser le lien. Enregistrez le plugin du panneau CRM (qui fournit cette route) ou définissez laravel-crm.user_interface=true.",
        'no_line_items_selected' => 'Aucune ligne sélectionnée',
        'nothing_left_to_deliver' => 'Plus rien à livrer',
        'nothing_left_to_deliver_body' => 'Toutes les lignes de cette commande ont déjà été livrées intégralement : il n\'y a donc rien à mettre sur une nouvelle livraison.',
    ],
